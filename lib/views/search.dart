...
class _SearchState extends State<Search> {
  ...
  late Stream<QuerySnapshot> searchResultSnapshot;
  ...
  initiateSearch() async {
    if(searchEditingController.text.isNotEmpty){
      ...
      searchResultSnapshot = await databaseMethods.searchByName(searchEditingController.text);
      setState(() {
        isLoading=false;
  ...
  Widget userList(){
    return haveUserSearched ? StreamBuilder<QuerySnapshot>(
